...
function isUserAlreadyLiked(post: Post, dbUserId: string | null): boolean {
	return post.likes.some(like => like.userId === dbUserId)
}
...
function PostCard({ post, dbUserId }: { post: Post, dbUserId: string | null }) {
	...
	const [hasLiked, setHasLiked] = useState(isUserAlreadyLiked(post, dbUserId))
	...
	const handleLike = async () => {
		...
		try {
			...
			setHasLiked(isUserAlreadyLiked(post, dbUserId))
